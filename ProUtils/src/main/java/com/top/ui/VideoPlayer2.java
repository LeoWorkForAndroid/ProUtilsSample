...
public class VideoPlayer2 extends RelativeLayout {
    ...
    private Uri uri = Uri.parse("http://10.0.2.2/video/video.mp4");
    ...
    private void init(final Context context) {
        ...
        LinearLayout.LayoutParams play2Params = new LinearLayout.LayoutParams(
                0,
                dip2px(20),
                0.4f);//此处我需要均分高度就在heignt处设0,1.0f即设置权重是1，页面还有其他一个控件,1：1高度就均分了

        play2Params.leftMargin = dip2px(10);

        play2 = new ImageButton(context);
        play2.setBackgroundResource(R.drawable.ic_play);
        ...
        linearLayout.addView(play2, play2Params);
